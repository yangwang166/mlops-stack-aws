module "aws_create_sp" {
  ...
  service_principal_name       = "mlops-stack-aws-seek-cicd"
  project_directory_path       = "/mlops-stack-aws-seek"
  service_principal_group_name = "mlops-stack-aws-seek-service-principals"
}
